...
- [x] T048 [P] Add unit tests for reachability from Sol (15 LY hop graph)
...
- [x] T052 Add CLI flags `--colonization-mode` (standard|none) and `--require-sol-route`
- [x] T053 Update settlement candidate search to use 15 LY bucket sizing
- [x] T054 Implement cube-based reachability flagging: mark Sol's cube reachable,
